  ...
  const principles = [
    {
      ...
      description: "Every decision is built on real data, not guesswork.",
      align: "left",
    },
    {
      number: "02",
      ...
      description: "Launch faster. Scale smarter. No wasted time or budget.",
      align: "right",
    },
    {
      number: "03",
      ...
      description:
        "Weekly reports and constant communication — you always know what’s happening.",
      align: "left",
    },
    {
      number: "04",
      titleParts: [
        { text: "PURPOSEFUL ", highlight: false },
        { text: "CREATIVITY", highlight: true },
      ],
      description: "Beautiful creatives — but always with one goal: sales.",
      align: "right",
    },
    {
      number: "05",
      ...
      description: "We build brands that last, not campaigns that fade.",
      align: "left",
    },
  ];
    ...
    >
      ...
      <div ref={headerRef} className="mb-24">
        ...
        <h2 className="mt-4 font-[var(--font-bebas)] text-5xl md:text-7xl tracking-tight">
          How We Work — Our Core Principles
        </h2>
      </div>
