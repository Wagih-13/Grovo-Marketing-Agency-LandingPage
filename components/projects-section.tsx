...
const projects = [
  {
    title: "Special programming — Modest Wear",
    description: `
      ModestWear is a full-stack e-commerce application for modest fashion.
Built with modern, scalable technologies and clean architecture.
Developed using Next.js, TypeScript, Node.js, PostgreSQL, and Prisma.
`,
    image: "/project-1.jpeg",
    tag: "Store Building",
  },
  {
    title: " Shopify Theme — Marlon",
    description:
